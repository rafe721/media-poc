...
<body ng-app="myApp" ng-controller="slotsCtrl">
	<!--
			...
			<div class="content_wrapper">
						...
						<div class="content_list">
							<ul ng-init="getAll()">
								<li ng-if="displays" ng-repeat="d in displays">
									<a href="#" ng-click="readOne(d.display_id, d.slot_no)">{{ d.media_name }}</a>
								</li>
								<li ng-if="!displays">
									<a href="#" >No Results</a>
								</li>
				...
				<!-- The overlay -->
					<div id="myNav" class="overlay">
						...
						<!-- Overlay content -->
						<div class="overlay-content" ng-if="ui.media_id!=0">
							<a href="#" ng-click="updateSlot(ui.display_id, ui.slot_no, 0)">Clear</a>
							<a href="#" ng-click="updateSlot(ui.display_id, ui.slot_no, 34)">Swap</a>
							<b>Media_Name: </b>{{ ui.media_name }} <br/>
							<b>media_id: </b>{{ ui.media_id }} <br/>
							<b>slot_no: </b>{{ ui.slot_no }} <br/>
							<b>display_id: </b>{{ ui.display_id }} <br/>
						</div>
						<div class="overlay-content" ng-if="ui.media_id==0">
							<a href="#" ng-click="updateSlot(ui.display_id, ui.slot_no, 34)">Add</a>
							<b>Media_Name: </b>{{ ui.media_name }} <br/>
							<b>media_id: </b>{{ ui.media_id }} <br/>
							<b>slot_no: </b>{{ ui.slot_no }} <br/>
							<b>display_id: </b>{{ ui.display_id }} <br/>
...
<!-- product -->
<script type="text/javascript" src="app/slots/controller.js"></script>
